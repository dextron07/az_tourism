...
const changeSideBar = () => {
    ...
    let popularDestinationAppear = document.querySelector('#section-destinations .slide-show');
    let popularDestinationAppearPosition = popularDestinationAppear.getBoundingClientRect().top;

    let popularPackageAppear = document.querySelector('#section-packages .slide-show');
    let popularPackageAppearPosition = popularPackageAppear.getBoundingClientRect().top;
